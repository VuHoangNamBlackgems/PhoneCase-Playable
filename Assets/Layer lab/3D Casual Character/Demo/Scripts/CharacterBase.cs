...
namespace Layer_lab._3D_Casual_Character
{
    ...
    {
        public List<GameObject> PartsBody { get; set; } = new List<GameObject>();
        public List<GameObject> PartsHair { get; set; } = new List<GameObject>();
        public List<GameObject> PartsFace { get; set; } = new List<GameObject>();
        public List<GameObject> PartsHeadGear { get; set; } = new List<GameObject>();
        public List<GameObject> PartsTop { get; set; } = new List<GameObject>();
        public List<GameObject> PartsBottom { get; set; } = new List<GameObject>();
        public List<GameObject> PartsEyewear { get; set; } = new List<GameObject>();
        public List<GameObject> PartsBag { get; set; } = new List<GameObject>();
        public List<GameObject> PartsShoes { get; set; } = new List<GameObject>();
        public List<GameObject> PartsGlove { get; set; } = new List<GameObject>();
